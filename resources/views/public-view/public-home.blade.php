...
<main>
    ...
    <div class="our-services section-pad-t30">
        <div class="container">
            ...
            <div class="row d-flex justify-contnet-center">
                ...
                {{-- <div class="row">
                    <div class="col-lg-12">
                        <div class="browse-btn2 text-center mt-40">
                        ...
                        <div class="job-items">
                            <div class="company-img">
                                <a href="job_details.html"><img
                                        src="{{asset('public-theme/assets/img/icon/job-list1.png')}}" alt=""></a>
    </div>
    ...
    <div class="single-job-items mb-30">
        <div class="job-items">
            <div class="company-img">
                <a href="job_details.html"><img src="{{asset('public-theme/assets/img/icon/job-list2.png')}}"
                        alt=""></a>
            </div>
            <div class="job-tittle">
                <a href="job_details.html">
    ...
    <div class="single-job-items mb-30">
        <div class="job-items">
            <div class="company-img">
                <a href="job_details.html"><img src="{{asset('public-theme/assets/img/icon/job-list3.png')}}"
                        alt=""></a>
            </div>
            <div class="job-tittle">
                <a href="job_details.html">
    ...
    <div class="single-job-items mb-30">
        <div class="job-items">
            <div class="company-img">
                <a href="job_details.html"><img src="{{asset('public-theme/assets/img/icon/job-list4.png')}}"
                        alt=""></a>
            </div>
            <div class="job-tittle">
                <a href="job_details.html">
                            ...
                            <div class="testimonial-caption ">
                                ...
                                <div class="testimonial-founder  ">
                                    <div class="founder-img mb-30">
                                        <img src="{{asset('public-theme/assets/img/testmonial/testimonial-founder.png')}}"
    alt="">
    ...
    <div class="single-testimonial text-center">
        ...
        <div class="testimonial-caption ">
            ...
            <div class="testimonial-founder  ">
                <div class="founder-img mb-30">
                    <img src="{{asset('public-theme/assets/img/testmonial/testimonial-founder.png')}}" alt="">
                    <span>Margaret Lawson</span>
                    <p>Creative Director</p>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-6 col-lg-6">
                    <div class="support-location-img">
                        <img src="{{asset('public-theme/assets/img/service/support-img.jpg')}}" alt="">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="home-blog-single mb-30">
                        <div class="blog-img-cap">
                            <div class="blog-img">
                                <img src="{{asset('public-theme/assets/img/blog/home-blog1.jpg')}}" alt="">
    <!-- Blog date -->
    ...
    <div class="col-xl-6 col-lg-6 col-md-6">
        <div class="home-blog-single mb-30">
            <div class="blog-img-cap">
                <div class="blog-img">
                    <img src="{{asset('public-theme/assets/img/blog/home-blog2.jpg')}}" alt="">
                    <!-- Blog date -->
                    <div class="blog-date text-center">
                        <span>24</span>
                        <p>Now</p>
