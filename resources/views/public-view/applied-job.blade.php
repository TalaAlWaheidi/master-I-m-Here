                    ...
                    <form action="{{route('applied.store',$job->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mt-10">
                            <input type="text" name="name" placeholder="Full Name" onfocus="this.placeholder = ''"
                                onblur="this.placeholder = 'First Name'" class="single-input">
                        </div>
                        @error('name')
                        ...
                        <div class="mt-10">
                            <input type="text" name="phone" placeholder="Your Phone" onfocus="this.placeholder = ''"
                                onblur="this.placeholder = 'Your Phone'" class="single-input">
                        </div>
                        @error('phone')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                        <div class="mt-10">
                            <input type="text" name="desability" placeholder="Your Desability"
                                onfocus="this.placeholder = ''" onblur="this.placeholder = 'Your Desability'"
                                class="single-input">
                        </div>
                        @error('desability')
                        <div class="text-danger">{{ $message }}</div>
...
{{--                            <i class="far fa-address-book"></i>--}}
                            ...
                            <input type="file" name="CV" placeholder="Upload Your CV" onfocus="this.placeholder = ''"
                                onblur="this.placeholder = 'Upload Your CV'" class="single-input">
                        </div>
                        @error('cv')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
...
{{--                            <i class="fas fa-camera-retro"></i>--}}
                            ...
                            <input type="file" name="image" placeholder="Upload Your Image"
                                onfocus="this.placeholder = ''" onblur="this.placeholder = 'Upload Your Image'"
                                class="single-input">
                        </div>
                        @error('image')
                        <div class="text-danger">{{ $message }}</div>
